...
import { createContext as Be, useState as b, useMemo as de, useEffect as E, useContext as Me, useRef as ee, useCallback as Ee } from "react";
const Te = {
...
function Re(t) {
  return t ? t in U ? t : Te[t] ?? "new-haze" : "new-haze";
}
const X = {
  s0: "hsl(0, 0%,  4%)",
  s1: "hsl(0, 0%,  8%)",
...
function $e() {
  ...
  t.setAttribute("data-nh", "static"), t.textContent = Pe, document.head.appendChild(t), ue = !0;
}
const ye = Be(null), De = {
...
function Fe(t, r) {
  ...
  o.style.setProperty("--nh-s0", r.s0), o.style.setProperty("--nh-s1", r.s1), o.style.setProperty("--nh-s2", r.s2), o.style.setProperty("--nh-s3", r.s3), o.style.setProperty("--nh-shadow-sm", r.shadowSm), o.style.setProperty("--nh-shadow-lg", r.shadowLg), o.style.setProperty("--nh-bg-dark", r.s0), o.style.setProperty("--nh-bg", r.s1), o.style.setProperty("--nh-bg-light", r.s2), o.style.setProperty("--nh-text", r.text), o.style.setProperty("--nh-text-muted", r.textMuted), o.style.setProperty("--nh-text-dim", r.textDim), o.style.setProperty("--nh-border", r.border), o.style.setProperty("--nh-border-light", r.borderLight), o.style.setProperty("--nh-accent", r.accent), o.style.setProperty("--nh-accent-bright", r.accentBright), o.style.setProperty("--nh-accent-neon", r.accentNeon), o.style.setProperty("--nh-secondary", r.secondary), o.style.setProperty("--nh-secondary-bright", r.secondaryBright), o.style.setProperty("--nh-error", r.error), o.style.setProperty("--nh-error-bg", r.errorBg), o.style.setProperty("--nh-error-border", r.errorBorder), o.style.setProperty("--nh-success", r.success), o.style.setProperty("--nh-success-bg", r.successBg), o.style.setProperty("--nh-success-border", r.successBorder), o.style.setProperty("--nh-focus", r.focus), o.classList.remove("dark", "new-haze", "rabbitek", "canahoria", "light"), De[t].forEach((i) => o.classList.add(i)), o.style.colorScheme = Ne[t];
}
function mt({ children: t }) {
  const [r, o] = b(pe), i = de(() => U[r].colors, [r]);
  E(() => {
    try {
      const h = Re(localStorage.getItem(he));
      h !== pe && o(h);
    } catch {
    }
  }, []), E(() => {
  ...
  return /* @__PURE__ */ e(ye.Provider, { value: { theme: i, themeName: r, setThemeName: a, themeOptions: c }, children: t });
}
function v() {
  const t = Me(ye);
...
function xe({
  ...
  if (t === "icon")
    return /* @__PURE__ */ e(
      "svg",
      {
        ...
        "aria-label": h,
        role: "img",
        children: /* @__PURE__ */ e(ge, { color: o, accentColor: i })
      }
    );
  if (t === "wordmark")
    return /* @__PURE__ */ e(
      "svg",
      {
        ...
        "aria-label": h,
        role: "img",
        children: /* @__PURE__ */ e(me, { color: o })
      }
    );
  ...
  return /* @__PURE__ */ s(
    "svg",
    {
      ...
      role: "img",
      children: [
        /* @__PURE__ */ e("g", { transform: `scale(${p})`, children: /* @__PURE__ */ e(ge, { color: o, accentColor: i }) }),
        /* @__PURE__ */ e("g", { transform: `translate(${w}, 0)`, children: /* @__PURE__ */ e(me, { color: o }) })
      ]
    }
  );
}
...
function We() {
  const { theme: t, themeName: r, setThemeName: o, themeOptions: i } = v(), [a, c] = b(!1), h = ee(null);
  return E(() => {
    if (!a) return;
    function p(m) {
    ...
    a && /* @__PURE__ */ e("div", { style: {
      ...
      "button",
      {
        ...
        style: {
          ...
          width: "100%",
          padding: "6px 10px",
          background: r === p.value ? t.s2 : "transparent",
          border: "none",
          borderRadius: 6,
          cursor: "pointer",
          fontSize: 12,
        ...
        children: [
          /* @__PURE__ */ e("span", { children: be[p.value] }),
          /* @__PURE__ */ e("span", { style: { flex: 1, textAlign: "left" }, children: p.label }),
          r === p.value && /* @__PURE__ */ e("span", { style: { color: t.accent }, children: "✓" })
        ]
      },
      p.value
    )) })
...
function Ae(t = 768) {
  const [r, o] = b(!1);
  return E(() => {
    const i = window.matchMedia(`(max-width: ${t - 1}px)`);
    o(i.matches);
    const a = (c) => o(c.matches);
...
function je(t, r) {
  return r.some((o) => t.includes(o));
}
function Ze({ href: t, children: r, style: o, "aria-label": i }) {
  return /* @__PURE__ */ e("a", { href: t, style: o, "aria-label": i, children: r });
}
function He({ user: t, onLogout: r, profileHref: o, LinkComponent: i }) {
  const { theme: a } = v(), [c, h] = b(!1), p = ee(null);
  return E(() => {
    if (!c) return;
    const m = (y) => {
    ...
    c && /* @__PURE__ */ s("div", { style: {
      ...
      /* @__PURE__ */ s("div", { style: { padding: "10px 16px 12px", borderBottom: `1px solid ${a.border}` }, children: [
        /* @__PURE__ */ e("div", { style: { fontSize: 13, fontWeight: 700, color: a.text }, children: t.username }),
        /* @__PURE__ */ e("div", { style: { fontSize: 11, color: a.textDim, marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: t.email })
      ] }),
      o && /* @__PURE__ */ e("div", { style: { padding: "4px 8px 0" }, children: /* @__PURE__ */ e(
        i,
        {
          href: o,
          style: {
      ...
      /* @__PURE__ */ e("div", { style: { padding: "4px 8px 4px" }, children: /* @__PURE__ */ e(
        "button",
        {
          ...
          onMouseEnter: (m) => {
            ...
            y.style.background = a.s2, y.style.color = a.text;
          },
          onMouseLeave: (m) => {
            const y = m.currentTarget;
            y.style.background = "none", y.style.color = a.textMuted;
          },
...
function bt({
  ...
  return /* @__PURE__ */ s("header", { style: {
    ...
    !w && /* @__PURE__ */ s("nav", { style: { display: "flex", gap: 20, alignItems: "center" }, children: [
      C.map((d) => /* @__PURE__ */ e(c, { href: d.href, style: l(t === d.app), children: d.label }, d.app)),
      m == null ? void 0 : m.map((d) => /* @__PURE__ */ e(c, { href: d.href, style: l(!1), children: d.label }, d.href)),
      r && Le.map(
        (d) => je(r.roles, d.roles) ? /* @__PURE__ */ e(c, { href: d.href, style: l(!1), children: d.label }, d.label) : null
      )
    ] }),
    /* @__PURE__ */ s("div", { style: { marginLeft: "auto", display: "flex", alignItems: "center", gap: 10 }, children: [
      /* @__PURE__ */ e(We, {}),
      r ? /* @__PURE__ */ e(He, { user: r, onLogout: i, profileHref: a, LinkComponent: c }) : /* @__PURE__ */ e(
        "button",
        {
          onClick: o,
          style: {
...
function O({ children: t, title: r, subtitle: o }) {
  const { theme: i } = v();
  return /* @__PURE__ */ s("div", { style: {
    ...
    r && /* @__PURE__ */ s("div", { style: { marginBottom: o ? 8 : 20 }, children: [
      /* @__PURE__ */ e("div", { style: { fontSize: 20, fontWeight: 700, color: i.text }, children: r }),
      o && /* @__PURE__ */ e("div", { style: { fontSize: 13, color: i.textMuted, marginTop: 4 }, children: o })
    ] }),
    t
  ] });
}
...
function Ke({
  ...
  const { theme: l } = v(), [d, W] = b(m), [x, A] = b(""), [S, f] = b(""), [L, K] = b(["", "", "", "", "", ""]), [G, we] = b(""), [z, Y] = b(null), [k, te] = b(!1), [B, q] = b(0), [re, ve] = b(!1), $ = ee([]);
  E(() => {
    if (B <= 0) return;
    const n = setTimeout(() => q((u) => u - 1), 1e3);
  ...
  const T = (n) => {
    ...
    M[n] = g, K(M), g && n < 5 && ((I = $.current[n + 1]) == null || I.focus());
  }, Se = (n, u) => {
    var g;
    u.key === "Backspace" && !L[n] && n > 0 && ((g = $.current[n - 1]) == null || g.focus()), u.key === "Enter" && oe();
  }, V = Ee(async (n) => {
    !(n != null && n.credential) || !a || await R(async () => {
      await a(n.credential);
    });
  }, [a]);
  E(() => {
    var u, g;
  ...
  const _e = () => {
    var n, u, g;
    (g = (u = (n = window.google) == null ? void 0 : n.accounts) == null ? void 0 : u.id) == null || g.prompt();
  }, ze = (n) => {
    var M;
    const u = n.clipboardData.getData("text").replace(/\D/g, "").slice(0, 6);
    if (!u) return;
    n.preventDefault();
    ...
    d === "otp" && /* @__PURE__ */ s(O, { title: "Revisá tu email", subtitle: /* @__PURE__ */ s(F, { children: [
      ...
      /* @__PURE__ */ e("div", { style: { display: "flex", gap: 8, justifyContent: "center", margin: "24px 0" }, onPaste: ze, children: L.map((n, u) => /* @__PURE__ */ e(
        "input",
        {
          ref: (g) => {
            $.current[u] = g;
          ...
          style: {
            ...
            fontWeight: 700,
            background: l.s2,
            border: `1.5px solid ${n ? l.accent : l.border}`,
            borderRadius: 10,
            color: l.text,
            outline: "none",
            fontFamily: "inherit",
          ...
          onBlur: (g) => {
            g.target.style.borderColor = n ? l.accent : l.border;
          }
        },
        u
      )) }),
    ...
    d === "profile" && /* @__PURE__ */ e(O, { title: "¿Cómo querés que te llamen?", subtitle: "Podés cambiarlo después desde tu perfil", children: /* @__PURE__ */ s("div", { style: { display: "flex", flexDirection: "column", gap: 12, marginTop: 16 }, children: [
      /* @__PURE__ */ e(
        "input",
        {
          ...
          style: j,
          onFocus: (n) => {
            n.target.style.borderColor = l.accent;
          },
          onBlur: (n) => {
            n.target.style.borderColor = l.border;
          },
          onKeyDown: (n) => n.key === "Enter" && se()
        }
      ),
      z && /* @__PURE__ */ e(Z, { msg: z }),
    ...
    d === "forgot_sent" && /* @__PURE__ */ e(
      O,
      {
        ...
        children: /* @__PURE__ */ e("button", { style: { ...D, marginTop: 20 }, onClick: () => T("login"), children: "Volver al inicio de sesión" })
      }
    ),
    ...
    (d === "login" || d === "register") && /* @__PURE__ */ s(O, { children: [
        ...
        /* @__PURE__ */ s("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ e(
            "input",
            {
              ...
              onKeyDown: (n) => n.key === "Enter" && (d === "login" ? ie() : ne())
            }
          ),
          /* @__PURE__ */ e(
            "button",
      ...
      /* @__PURE__ */ s("div", { style: { textAlign: "center", marginTop: 20, fontSize: 13, color: l.textMuted, fontFamily: "inherit" }, children: [
        ...
        /* @__PURE__ */ e(
          "span",
          {
            onClick: () => T(d === "login" ? "register" : "login"),
      ...
      p && /* @__PURE__ */ s("div", { style: { textAlign: "center", marginTop: 16 }, children: [
        /* @__PURE__ */ e(
          "button",
          {
            ...
            onMouseEnter: (n) => {
              n.currentTarget.style.color = l.textMuted;
            },
            onMouseLeave: (n) => {
              n.currentTarget.style.color = l.textDim;
            },
  ...
  return y ? le : /* @__PURE__ */ e(Ue, { children: le });
}
function yt({ onClose: t, initialMode: r, authScreenProps: o }) {
  const { theme: i } = v();
  return /* @__PURE__ */ e(
    "div",
    {
...
function xt({ user: t, onUpdateUsername: r, onLogout: o }) {
  const { theme: i } = v(), [a, c] = b(t.username ?? ""), [h, p] = b(!1), [m, y] = b(null), [w, C] = b(!1), [l, d] = b(!1), W = async () => {
    if (!a.trim()) {
      y("Ingresá un nombre de usuario");
      return;
    }
    y(null), p(!0), C(!1);
    try {
      await r(a.trim()), C(!0), setTimeout(() => C(!1), 2e3);
    } catch (f) {
      y(f.message);
    } finally {
      p(!1);
  ...
  return /* @__PURE__ */ s("div", { style: { display: "flex", flexDirection: "column", gap: 24, padding: "8px 0" }, children: [
    /* @__PURE__ */ s("div", { style: { display: "flex", alignItems: "center", gap: 16 }, children: [
      ...
      /* @__PURE__ */ s("div", { style: { minWidth: 0 }, children: [
        /* @__PURE__ */ e("div", { style: { fontSize: 17, fontWeight: 700, color: i.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: t.username ?? "Sin nombre" }),
        /* @__PURE__ */ e("div", { style: { fontSize: 13, color: i.textMuted, marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: t.email }),
        t.roles && t.roles.length > 0 && /* @__PURE__ */ e("div", { style: { display: "flex", gap: 6, marginTop: 6, flexWrap: "wrap" }, children: t.roles.map((f) => /* @__PURE__ */ e(
          "span",
          {
            style: {
              fontSize: 10,
    ...
    t.xp != null && t.level != null && S != null && /* @__PURE__ */ s("div", { children: [
...
function fe({ children: t, active: r = !1, onClick: o, style: i, className: a }) {
  const { theme: c } = v();
  return /* @__PURE__ */ e(
    "div",
    {
      ...
      style: {
        background: c.s2,
        border: `1px solid ${r ? c.borderLight : c.border}`,
        borderRadius: 16,
        padding: "20px 20px",
        cursor: o ? "pointer" : "default",
        transition: "box-shadow 0.2s ease",
        boxShadow: r ? c.shadowLg : c.shadowSm,
        ...i
      },
      children: t
    }
...
function ft({ children: t, style: r, className: o }) {
  const { theme: i } = v();
  return /* @__PURE__ */ e(
    "div",
    {
...
const Ge = "_wrapper_1ej2d_1", Ye = "_imageWrapper_1ej2d_19", qe = "_image_1ej2d_19", Ve = "_body_1ej2d_51", Je = "_title_1ej2d_67", Xe = "_description_1ej2d_77", Qe = "_price_1ej2d_87", P = {
  wrapper: Ge,
  imageWrapper: Ye,
  image: qe,
  body: Ve,
...
function vt({ image: t, imageAlt: r, title: o, description: i, price: a }) {
  const { theme: c } = v();
  return /* @__PURE__ */ e("div", { className: P.wrapper, children: /* @__PURE__ */ s(fe, { style: { padding: 0, overflow: "hidden", display: "flex", flexDirection: "column", height: "100%" }, children: [
    /* @__PURE__ */ e("div", { className: P.imageWrapper, children: /* @__PURE__ */ e("img", { src: t, alt: r ?? o, className: P.image }) }),
    /* @__PURE__ */ s("div", { className: P.body, children: [
      /* @__PURE__ */ e("h3", { className: P.title, style: { color: c.text }, children: o }),
      /* @__PURE__ */ e("p", { className: P.description, style: { color: c.textMuted }, children: i }),
      /* @__PURE__ */ e("p", { className: P.price, style: { color: c.accentBright }, children: a })
    ] })
  ] }) });
}
    ...
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ s("div", { className: _.imageWrapper, children: [
          /* @__PURE__ */ e("img", { src: o || "/placeholder.svg", alt: t, className: _.image }),
          /* @__PURE__ */ e("div", { className: _.imageOverlay })
        ] }),
        /* @__PURE__ */ s("div", { className: _.body, children: [
          /* @__PURE__ */ e("h3", { className: _.title, style: { color: p.text }, children: t }),
          /* @__PURE__ */ e("p", { className: _.excerpt, style: { color: p.textMuted }, children: r }),
...
function Ct({ icon: t, title: r, description: o, iconVariant: i = "accent" }) {
  ...
  return /* @__PURE__ */ s(fe, { className: H.card, children: [
    /* @__PURE__ */ e("div", { className: H.iconCircle, style: { background: c }, children: t }),
    /* @__PURE__ */ e("h3", { className: H.title, style: { color: a.text }, children: r }),
    /* @__PURE__ */ e("p", { className: H.description, style: { color: a.textMuted }, children: o })
  ] });
}
export {
  yt as AuthModal,
