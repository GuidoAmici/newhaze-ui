    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, padding: '8px 0' }}>
              ...
              {user.roles.map(role => (
                <span
                  ...
                  style={{
                    ...
                    background: theme.bgCardLight, border: `1px solid ${theme.borderLight}`,
      ...
      {user.xp != null && user.level != null && xpPercent != null && (
        <div>
          ...
          <div style={{ height: 8, background: theme.bgCardLight, borderRadius: 99, overflow: 'hidden', border: `1px solid ${theme.border}` }}>
            <div style={{
              height: '100%',
              width: `${xpPercent}%`,
